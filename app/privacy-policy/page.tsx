...
export default async function PrivacyPolicyPage() {
  const { miscellaneous } = await getInformation();
  ...
  return (
    <>
      ...
      <main className='container max-w-6xl px-4 md:px-8 mx-auto -mt-5 xl:mt-5 relative overflow-x-hidden'>
        ...
        <h3 className='font-bold text-2xl mb-4 pt-4'>
          Types of Data Collected
        </h3>
        <h4 className='font-bold text-lg pt-2 mb-4'>Personal Data</h4>
        <p className='mb-4 text-base'>
        ...
        <ul className='list-outside list-disc block ml-10'>
          <li className='list-item'>
            <p className='mb-4 text-base'>Email address</p>
          </li>
          <li className='list-item'>
            <p className='mb-4 text-base'>First name and last name</p>
          </li>
          <li className='list-item'>
            <p className='mb-4 text-base'>Usage Data</p>
          </li>
        </ul>
        <h4 className='font-bold text-lg pt-2 mb-4'>Usage Data</h4>
        <p className='mb-4 text-base'>
        ...
        <h4 className='font-bold text-lg pt-2 mb-4'>
        ...
        <ul className='list-outside list-disc block ml-10'>
          <li className='list-item'>
            ...
            <p className='mb-4 text-base'>Type: Session Cookies</p>
            <p className='mb-4 text-base'>Administered by: Us</p>
            <p className='mb-4 text-base'>
          ...
          <li className='list-item'>
            ...
            <p className='mb-4 text-base'>Type: Persistent Cookies</p>
            <p className='mb-4 text-base'>Administered by: Us</p>
            <p className='mb-4 text-base'>
        ...
        <h4 className='font-bold text-lg pt-2 mb-4'>Business Transactions</h4>
        <p className='mb-4 text-base'>
        ...
        <h4 className='font-bold text-lg pt-2 mb-4'>Law enforcement</h4>
        <p className='mb-4 text-base'>
