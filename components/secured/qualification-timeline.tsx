      ...
      <div className='relative wrap overflow-hidden h-full'>
        ...
        {data?.map((value, index) => (
          ...
          >
            ...
            <div className='z-20 flex items-center order-1 bg-primary shadow-xl w-6 h-6 rounded-full border-4 border-primary-foreground' />
            <div className='order-1 w-5/12 text-primary'>
              ...
              >
                <div className='rounded-full bg-primary-foreground w-6 h-6 flex justify-center items-center p-1'>
